...
CArea::CArea(CWnd* pParent /*=NULL*/)
	: CDialog(CArea::IDD, pParent),selectTE(false),selectDE(false)
{
	//{{AFX_DATA_INIT(CArea)
	m_TE = 0.0;
	m_DE = 0.0;
...
void CArea::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CArea, CDialog)
	//{{AFX_MSG_MAP(CArea)
...
double CArea::Convert(int r1,int r2,double x){
	double xx=x;
	...
	case 0:
		...
		case 2:yy=xx*pow(10,-4);break;
		case 3:yy=xx*pow(10,-6);break;
		case 4:yy=xx*pow(10,-12);break;
		case 5:yy=xx*pow(10,-10);break;
		case 6:yy=xx*pow(10,-8);break;
		}
		break;
	//cm^2
	case 1:
		switch(r2){
		case 0:yy=xx*pow(10,2);break;
		case 1:yy=xx;break;
		case 2:yy=xx*pow(10,-2);break;
		case 3:yy=xx*pow(10,-4);break;
		case 4:yy=xx*pow(10,-10);break;
		case 5:yy=xx*pow(10,-8);break;
	...
	case 4:
		...
		case 1:yy=xx*pow(10,10);break;
		case 2:yy=xx*pow(10,8);break;
		case 3:yy=xx*pow(10,6);break;
		case 4:yy=xx;break;
...
void CArea::OnSelchangeLTopCombo() 
{
...
void CArea::OnSelchangeLDownCombo() 
{
	// TODO: Add your control notification handler code here
	/*selectDC=true;
...
void CArea::OnSetfocusLDownEdit() 
{
...
//全选edit
BOOL CArea::PreTranslateMessage(MSG* pMsg) 
{
	// TODO: Add your specialized code here and/or call the base class
